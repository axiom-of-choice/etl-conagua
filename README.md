...
### **IMPORTANT NOTE**
At the time of submitting this project, the webservice that I used to request the data hasn't generated new data, you can confirm this running the notebook project.ipynb previously having built a Python virtual
